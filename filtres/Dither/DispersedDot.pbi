...
Procedure DispersedDot_MT(*param.parametre)
...
Procedure DispersedDot(*param.parametre)
  If *param\info_active
    *param\typ = #FilterType_Dithering
    *param\subtype = #Dither_Ordered
    *param\name = "Dispersed Dot"
    *param\remarque = "Dispersed Dot ordered dithering (blue noise)"
  ...
  filter_start(@DispersedDot_MT(), 2, 1)
EndProcedure
