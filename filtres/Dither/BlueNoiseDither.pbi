...
Procedure BlueNoise_MT(*param.parametre)
...
Procedure BlueNoiseDither(*param.parametre)
  If *param\info_active
    *param\typ = #FilterType_Dithering
    *param\subtype = #Dither_Stochastic
    *param\name = "Blue Noise"
    *param\remarque = "Blue Noise ordered dithering (high visual quality)"
