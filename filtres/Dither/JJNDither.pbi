...
; ------------------------------------------------------------------------------
Procedure JJNDither_MT(*FilterCtx.FilterParams)
  With *FilterCtx
...
Procedure JJNDitherEx(*FilterCtx.FilterParams)
  Restore JJNDither_data
  Protected last_data = Filter_InitAndValidate()
  If last_data < 0 : ProcedureReturn 0 : EndIf
  
  With *FilterCtx
    ; Lancement du filtre (1 thread car le dithering avancé nécessite un ordre séquentiel)
    Create_MultiThread_MT(@JJNDither_MT(), 1)
    
    mask_update(*FilterCtx.FilterParams, last_data)
  EndWith
EndProcedure

Procedure JJNDither(source, cible, mask, levels, gray)
  Set_Source(source)
  Set_Cible(cible)
  Set_Mask(mask)
  With FilterCtx
    ...
    \option[1] = gray
  EndWith
  JJNDitherEx(FilterCtx.FilterParams)
EndProcedure

DataSection
  JJNDither_data:
  Data.s "JJNDither"
  Data.s "Jarvis-Judice-Ninke dithering"
