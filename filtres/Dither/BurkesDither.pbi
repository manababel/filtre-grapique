...
Macro BurkesDither_DitherDiffuse(mul, div, offset)
...
Macro BurkesDither_DitherDiffuseGray(mul, div, offset)
  If currentPos + offset >= 0 And currentPos + offset < totalPixels
    *dstPixel.Pixel32 = *FilterCtx\addr[1] + (currentPos + offset) << 2
...
Procedure BurkesDither_MT(*FilterCtx.FilterParams)
  With *FilterCtx
        ...
        *dstPixel = \addr[1] + currentPos << 2
        ...
        If Not gray
          ...
          *dstPixel\l = alphaValue | (newR << 16) | (newG << 8) | newB
          ...
          BurkesDither_DitherDiffuse(8, 32, 1)
          BurkesDither_DitherDiffuse(4, 32, 2)
          BurkesDither_DitherDiffuse(2, 32, (lg - 2))
          BurkesDither_DitherDiffuse(4, 32, (lg - 1))
          BurkesDither_DitherDiffuse(8, 32, lg)
          BurkesDither_DitherDiffuse(4, 32, (lg + 1))
          BurkesDither_DitherDiffuse(2, 32, (lg + 2))
        Else
          ...
          *dstPixel\l = alphaValue | newG * $10101
          ...
          BurkesDither_DitherDiffuseGray(8, 32, 1)
          BurkesDither_DitherDiffuseGray(4, 32, 2)
          BurkesDither_DitherDiffuseGray(2, 32, (lg - 2))
          BurkesDither_DitherDiffuseGray(4, 32, (lg - 1))
          BurkesDither_DitherDiffuseGray(8, 32, lg)
          BurkesDither_DitherDiffuseGray(4, 32, (lg + 1))
          BurkesDither_DitherDiffuseGray(2, 32, (lg + 2))
        EndIf
      Next
...
Procedure BurkesDitherEx(*FilterCtx.FilterParams)
  Restore BurkesDither_data
  Protected last_data = Filter_InitAndValidate()
  If last_data < 0 : ProcedureReturn 0 : EndIf
  
  With *FilterCtx
    Create_MultiThread_MT(@BurkesDither_MT(), 1)
    mask_update(*FilterCtx.FilterParams, last_data)
  EndWith
EndProcedure

Procedure BurkesDither(source, cible, mask, levels, gray)
  Set_Source(source)
  Set_Cible(cible)
  Set_Mask(mask)
  With FilterCtx
    ...
    \option[1] = gray
  EndWith
  BurkesDitherEx(FilterCtx.FilterParams)
EndProcedure

DataSection
  BurkesDither_data:
  Data.s "BurkesDither"
  Data.s "Burkes dithering (2 lignes)"
