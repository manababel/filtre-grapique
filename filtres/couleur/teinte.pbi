...
Procedure teinte_MT(*FilterCtx.FilterParams)
  With *FilterCtx
    ...
    Protected hueShift = \option[0]  ; 0-360 degrés
...
Procedure teinteEx(*FilterCtx.FilterParams)
  Restore teinte_Data
  Protected last_data = Filter_InitAndValidate()
  If last_data < 0 : ProcedureReturn 0 : EndIf
  
  With *FilterCtx
    Create_MultiThread_MT(@teinte_MT())
    mask_update(*FilterCtx, last_data)
  EndWith
EndProcedure

Procedure teinte(source, cible, mask, hue_shift, mode)
  Set_Source(source)
  Set_Cible(cible)
  Set_Mask(mask)
  With FilterCtx
...
DataSection
  teinte_Data:
  Data.s "teinte"
  Data.s "Rotation de la teinte dans différents espaces colorimétriques"
