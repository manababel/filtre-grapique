...
Procedure MorphBlur_sp(*param.parametre)
...
Procedure MorphBlur(*param.parametre)
  If *param\info_active
    *param\typ = #FilterType_Blur
    *param\subtype = #Blur_Morphological
    *param\name = "MorphBlur"
    *param\remarque = "Flou morphologique basé sur la moyenne des extrema locaux"
    *param\info[0] = "Rayon"
