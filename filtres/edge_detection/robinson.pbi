Macro Macro_Robinson_calcul()
  ; --- DIRECTION 0 : N ---
  valR = (v\r[0] + v\r[1] + v\r[2]) - (v\r[6] + v\r[7] + v\r[8])
  valG = (v\g[0] + v\g[1] + v\g[2]) - (v\g[6] + v\g[7] + v\g[8])
  valB = (v\b[0] + v\b[1] + v\b[2]) - (v\b[6] + v\b[7] + v\b[8])
  rMax = Abs(valR) : gMax = Abs(valG) : bMax = Abs(valB)

  ; --- DIRECTION 1 : NE ---
  valR = (v\r[1] + v\r[2] + v\r[5]) - (v\r[3] + v\r[6] + v\r[7])
  valG = (v\g[1] + v\g[2] + v\g[5]) - (v\g[3] + v\g[6] + v\g[7])
  valB = (v\b[1] + v\b[2] + v\b[5]) - (v\b[3] + v\b[6] + v\b[7])
  ...
  ; --- DIRECTION 3 : SE ---
  valR = (v\r[5] + v\r[7] + v\r[8]) - (v\r[0] + v\r[1] + v\r[3])
  valG = (v\g[5] + v\g[7] + v\g[8]) - (v\g[0] + v\g[1] + v\g[3])
  valB = (v\b[5] + v\b[7] + v\b[8]) - (v\b[0] + v\b[1] + v\b[3])
  If Abs(valR) > rMax : rMax = Abs(valR) : EndIf
  If Abs(valG) > gMax : gMax = Abs(valG) : EndIf
  If Abs(valB) > bMax : bMax = Abs(valB) : EndIf

  ; --- DIRECTION 4 : S ---
  valR = (v\r[6] + v\r[7] + v\r[8]) - (v\r[0] + v\r[1] + v\r[2])
  valG = (v\g[6] + v\g[7] + v\g[8]) - (v\g[0] + v\g[1] + v\g[2])
  valB = (v\b[6] + v\b[7] + v\b[8]) - (v\b[0] + v\b[1] + v\b[2])
  If Abs(valR) > rMax : rMax = Abs(valR) : EndIf
  If Abs(valG) > gMax : gMax = Abs(valG) : EndIf
  If Abs(valB) > bMax : bMax = Abs(valB) : EndIf

  ; --- DIRECTION 5 : SW ---
  valR = (v\r[3] + v\r[6] + v\r[7]) - (v\r[1] + v\r[2] + v\r[5])
  valG = (v\g[3] + v\g[6] + v\g[7]) - (v\g[1] + v\g[2] + v\g[5])
  valB = (v\b[3] + v\b[6] + v\b[7]) - (v\b[1] + v\b[2] + v\b[5])
  If Abs(valR) > rMax : rMax = Abs(valR) : EndIf
  If Abs(valG) > gMax : gMax = Abs(valG) : EndIf
  If Abs(valB) > bMax : bMax = Abs(valB) : EndIf
  ...
  ; --- DIRECTION 7 : NW ---
  valR = (v\r[0] + v\r[1] + v\r[3]) - (v\r[5] + v\r[7] + v\r[8])
  valG = (v\g[0] + v\g[1] + v\g[3]) - (v\g[5] + v\g[7] + v\g[8])
  valB = (v\b[0] + v\b[1] + v\b[3]) - (v\b[5] + v\b[7] + v\b[8])
  If Abs(valR) > rMax : rMax = Abs(valR) : EndIf
  If Abs(valG) > gMax : gMax = Abs(valG) : EndIf
  If Abs(valB) > bMax : bMax = Abs(valB) : EndIf
EndMacro

Macro Macro_Robinson_lecture_pixel3x3()
  pos = ((y - 1) * lg) + (x - 1)
  ...
  With *FilterCtx
    ...
    *dst = \addr[1]
    ...
    For y = thread_start To thread_stop
      For x = 1 To lg - 2
        Macro_Robinson_lecture_pixel3x3()
...
Procedure Robinson_bords(*FilterCtx.FilterParams)
  With *FilterCtx
    Protected lg = \image_lg[0]
    Protected ht = \image_ht[0]
    Protected x, y
...
Procedure Robinson(source, cible, mask, multiplicateur=10, noir_blanc=0, inversion=0, seuil_bas = 0, seuil_haut = 255)
  Set_Source(source)
  Set_Cible(cible)
  Set_Mask(mask)
  With FilterCtx
...
DataSection
  Robinson_data:
  Data.s "Robinson"
  Data.s "Détection de contours par boussole 8 directions (Robinson 3x3)"
