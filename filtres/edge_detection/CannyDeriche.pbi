...
Procedure CannyDeriche_MT(*FilterCtx.FilterParams)
  With *FilterCtx
    ...
    Protected alpha.f = \option[0]
    Protected lowThreshold.f = \option[1]
    Protected highThreshold.f = \option[2]
...
Procedure CannyDericheEx(*FilterCtx.FilterParams)
  
  Restore CannyDeriche_data
  Protected last_data = Filter_InitAndValidate()
  If last_data < 0 : ProcedureReturn 0 : EndIf
  
    Create_MultiThread_MT(@CannyDeriche_MT())
    
    mask_update(*FilterCtx.FilterParams , last_data)
  
EndProcedure

Procedure CannyDeriche(source, cible, mask, alpha, seuilBas, seuilHaut, nb)
  Set_Source(source)
  Set_Cible(cible)
  Set_Mask(mask)
  With FilterCtx
    ...
    \option[3] = nb
  EndWith
  CannyDericheEx(FilterCtx)
EndProcedure

DataSection
  CannyDeriche_data:
  Data.s "Canny-Deriche"
  Data.s "Détection de contours optimale avec filtres IIR récursifs"
  Data.i #FilterType_EdgeDetection
  Data.i #EdgeDetect_Advanced
  
  Data.s "Alpha (échelle de lissage)"
  Data.i 1, 100, 50
  Data.s "Seuil bas"
  Data.i 0, 100, 10
  Data.s "Seuil haut"
